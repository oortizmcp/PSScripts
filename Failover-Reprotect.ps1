...
$rpisInContainer = Get-AzRecoveryServicesAsrReplicationProtectedItem -ProtectionContainer $recContainer | where {$drVmArmIds -contains $_.ProviderSpecificDetails.FabricObjectId}
